...
export default function InterfacePlate() {
  return (
    <section id="record" style={{ padding: "clamp(30px,4vw,56px) 0 clamp(48px,6vw,88px)" }}>
      <div className="om-grid-interface" style={{ display: "grid", gap: "28px clamp(24px,5vw,72px)", alignItems: "center" }}>
        <div>
          ...
          <p className="om-justify" style={{ fontSize: "15.5px", lineHeight: 1.64, margin: "22px 0 0", maxWidth: "46ch", color: "var(--color-neutral-800)" }}>
